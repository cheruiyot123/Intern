...
$query5 = mysqli_query($dbconn, "SELECT * FROM comment WHERE id ='$admin_id'");
...
<body>
  <form name="frmRegistration" method="post" action="insert_emp_log.php?id=<?php echo $result5['id']?>">
...
<tr>
  <tr>
<td>Supervisor Convenient Email</td>
