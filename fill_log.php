...
{
$id = $_GET['id'];
$query5 = mysqli_query($dbconn, "SELECT * FROM fill_details WHERE id ='$id'");
...
<body>
  <form name="frmRegistration" method="post" action="insert_log.php?id=<?php echo $result5['id'] ?>">
...
<tr>
<td>Department</td>
<td><input type="text" class="demoInputBox" name="dept" value="<?php echo $result5['department'] ?>" minlength="3" maxlength="16"  required ></td>
</tr>
<tr>
<td>email</td>
...
<tr>
  <tr>
<td>Work</td>
<td><textarea type="textarea" class="demoInputBox" name="work"  required ></textarea></td></tr>
<tr>
  <tr>
<td>Date</td>
<td><input type="date" class="demoInputBox" name="date" required ></td></tr>
<tr>
  <td>
