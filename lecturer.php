_<?php
        ...
        $query = mysqli_query( $dbconn, "SELECT * FROM lecture WHERE user_name='$username' and password='$password'");
         if (mysqli_num_rows($query) != 0)
        {
         echo "<script language='javascript' type='text/javascript'> location.href='lecture_home.php' </script>";   
          }
          else
          {
